...
%% Read Current folder
pwd
currentFolder = 'C:\Users\tareq\OneDrive\Desktop'; % Get current path (working directory)
pathin = '/dicomproc/'; % data directory
pathin = fullfile(currentFolder,pathin); % combine path
pathindir = '/dicomproc/*.DCM'; % search specific data type (*.DCM)
%% 
